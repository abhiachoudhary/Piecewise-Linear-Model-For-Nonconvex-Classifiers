...
%choose a dataset
a = load('Moon_SD.mat','a'); data_file = 'Moon_SD'; data_params = [-1.5 2.7 -1.5 1.5];
a = load('2D_LSD.mat'); data_file = '2D_LSD'; data_params = [3000 -2 1 -2 4 -2 4];
a = load('2D_PLSD.mat'); data_file = '2D_PLSD'; data_params = [3000 -2 1 2 -1 -2 4 -2 4];
a = load('2D_bendingLineSD.mat'); data_file = '2D_bendingLineSD'; data_params = [-1.5 2.7 -1.5 1.5];
a = load('2D_diamondSD.mat'); data_file = '2D_diamondSD'; data_params = [-1.5 1.5 -1.5 1.5];
a = load('2D_circlesSD.mat','a'); data_file = '2D_circlesSD'; data_params = [-1 1 -1 1];
a = load('2D_polySD.mat'); data_file = '2D_polySD'; data_params = [-1.5 1.6 -1.5 1.5];
a = load('2D_polySD_nw.mat'); data_file = '2D_polySD_nw'; data_params = [-3.2 3.2 -1.3 1.3];
